...
var generate = require("./statsGenerate.js");
var tokenizer_js_1 = require("./tokenizer.js");
var stats = require("./statsUI.js");
var statsUI = stats.statsUI;
function mainMobile(vocab, nouns, modelName, version) {
    return __awaiter(this, void 0, void 0, function () {
        var model, trie, processInput, processOutput;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    statsUI.setLoadingText("Loading (".concat(version, ")"));
                    statsUI.toggleLoadingScreen(true);
                    return [4 /*yield*/, generate.loadModel(tf, modelName)];
                case 1:
                    model = _a.sent();
                    trie = tokenizer_js_1.tokenizer.load(vocab);
                    ...
                    processOutput = function (predictions, index, noun) {
                        return tokenizer_js_1.tokenizer.processOutput(predictions, index, vocab, noun);
                    };
                    statsUI.setOnGenerate(function () {
                        return __awaiter(this, void 0, void 0, function () {
                            var enteredValue, results;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        statsUI.toggleGenerate(false);
                                        enteredValue = statsUI.getEnteredValue();
                                        return [4 /*yield*/, generate.generateStat(model, enteredValue, nouns, processInput, processOutput, statsUI.randomnessValue())];
                                    case 1:
                                        results = _a.sent();
